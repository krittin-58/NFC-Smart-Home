...
class ActionBundleManager {
    ...
    init() {
        ...
        let action_bundle_1 = ActionBundle(actionBundleId: 1, actions: [action_1, action_2])
        let action_bundle_2 = ActionBundle(actionBundleId: 2, actions: [action_3, action_4])
